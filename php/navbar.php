		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			...
			<ul class="navbar-nav ml-auto navbar-center">
				...
				<?php if (!class_exists('pluginSmart')) : ?> 
					...
					<li class="nav-item">
						<a class="nav-link<?php echo ($WHERE_AM_I == 'page' && $staticPage->permalink() === $page->permalink()) ? ' current-nav-link' : ''; ?>" href="<?php echo $staticPage->permalink(); ?>"><?php echo $staticPage->title(); ?></a>
					</li>
					<?php endforeach ?>
				<?php endif; ?>
